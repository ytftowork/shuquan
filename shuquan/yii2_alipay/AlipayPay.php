...
class AlipayPay {
     ...
     */
    public $partner = '2088011523895855';

    /**
     * @var String 收款支付宝账号
     */
    public $seller_email = '1454037941@qq.com';

    /**
     * @var String 安全检验码，以数字和字母组成的32位字符
     */
    public $key = 'lrtddx2udcwp5crsa15mbz02f0ku04a3';
     ...
     */
    public $notify_url = 'http://shuquan.53.haitou.cc/pay/notify';

    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
     */
    public $return_url = 'http://shuquan.53.haitou.cc/pay/return_call';
